...
<div style="box-shadow: 0px -5px 50px -3px rgba(0,0,0,0.49);margin-top: 150px;background: url(../../image/black.png);
    ...
    <div style="width: 33%;text-align: center;margin: 25px;">
       <div class="text-warning"><i class="fas fa-phone-square-alt"></i> <em style="font-size: 0.8em"> 06 31 31 18 17 </em> </div>
        <div class="text-warning"><i class="fas fa-envelope"></i> <em style="font-size: 0.8em"> Alegia@gmail.com </em> </div>
    </div>
</div>
